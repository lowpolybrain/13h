...
const point = {
    ...
    insideRegion(point, topLeft, bottomRight) {
...
const color = {
    ...
    hueBetween(fromInDeg, toInDeg, multiplier = 360) {
        const aaa = fromInDeg > multiplier
            ? fromInDeg % multiplier
            : fromInDeg;
        const bbb = toInDeg > multiplier ? toInDeg % multiplier : toInDeg;
...
class Canvas {
    ...
    poly(shape, fillStyle, lineWidth = 1, strokeColor, closePath = true, lineCap = exports.LineCap.Butt) {
        ...
        //@ts-expect-error These should exist at this point
...
exports.shape = shape;
//# sourceMappingURL=13h.core.js.map
